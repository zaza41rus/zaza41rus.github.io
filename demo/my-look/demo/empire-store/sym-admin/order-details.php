...
?>
<table><tr><td>
Name:</td><td><?php echo $addr_details['name'];?></td></tr><tr><td>
Mobile:</td><td><?php echo $addr_details['mobile'];?></td></tr><tr><td>
Address:</td><td><?php echo nl2br($addr_details['address']);?></td></tr><tr><td>
Country:</td><td><?php echo $addr_details['country'];?></td></tr><tr><td>
ZIP: </td><td><?php echo $addr_details['zip'];?></td></tr>
</table>
</td>
</tr>
</table>
