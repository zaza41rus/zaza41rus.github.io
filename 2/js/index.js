...
function cssVarsSetLighten() {
		...
		cssVar.setCSSVariableProperty('--star-background-color', 'rgba(241, 241, 241, 0)');  

		cssVar.setCSSVariableProperty('--sky-foreground', 'linear-gradient(to bottom, rgba(136,191,232,0) 0%,rgba(245,221,156,1) 100%)');  
		cssVar.setCSSVariableProperty('--boat-reflection', 'rgba(128, 125, 154, 0.5)');  
		// Man
		...
		cssVar.setCSSVariableProperty('--other-water-bg', '#6e6a8f');  
		// moon
		cssVar.setCSSVariableProperty('--moon-background-color', 'rgba(255, 255, 255, 0)');  
	}
	function cssVarsSetDarken() {
		...
		cssVar.setCSSVariableProperty('--window-shadow-in-color', 'rgba(0, 0, 0, 0.26)');  
		...
		cssVar.setCSSVariableProperty('--sky-foreground', 'linear-gradient(to bottom, rgba(136,191,232,0) 0%,#967973 100%)');  
		...
		// moon
		cssVar.setCSSVariableProperty('--moon-background-color', 'rgba(255, 255, 255, 1)');  
	}
