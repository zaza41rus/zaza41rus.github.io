...
if(isset($_REQUEST['action'])){
			...
			if(isset($_REQUEST['id']) && $_REQUEST['action'] == "edit"){
				...
				<form class="form-horizontal" action="addresses.php?id=<?php echo $id; ?>&action=edit" method="post" id="addr-edit">
					...
					<label class="col-sm-5 control-label text-right" for="addr-name">Recipient Name:</label><div class="col-sm-7">
					<input class="form-control" type="text" name="addr_name" value="<?php echo $addr['name'] ;?>" id="addr-name" ></div></div>
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-addr">Address:</label><div class="col-sm-7">
					<textarea  class="form-control" style="width:300px;height:100px;" name="addr_addr" id="addr-addr"><?php echo trim($addr['address']) ;?>
					</textarea></div></div>
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-c">Country:</label><div class="col-sm-7">
					<input class="form-control" type="text" name="addr_c" value="<?php echo $addr['country'] ;?>" id="addr-c" ></div></div>	<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="product-shipping-region">Region</label><div class="col-sm-7">
...
?></select></div></div>
					...
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-zip">Zip Code:</label><div class="col-sm-7">
					<input class="form-control" type="text" name="addr_zip" value="<?php echo $addr['zip'] ;?>" id="addr-zip" ></div></div>
					
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-mob">Mobile no:</label><div class="col-sm-7">
