...
/***/ function(module, exports, __webpack_require__) {
	...
	var textures = [{
	  file: 'img/autumn1.jpg',
	  name: 'image',
	  align: textureAlign,
	  scale: { x: 1, y: 1 }
	}, {
	  file: 'img/autumn2.jpg',
	  name: 'blur',
	  align: textureAlign,
	  scale: { x: 0.8, y: 0.8 }
	}, {
	  file: 'img/autumn3.jpg',
	  name: 'maps',
	  align: textureAlign,
	  scale: { x: 0.05, y: 0.05 }
	}, {
	...
	window.addEventListener('mousemove', function (event) {
	  if (!isTouchDevice) {
	    haze.gl.createUniform('2f', 'mouse', -curve(-1 + event.pageX / window.innerWidth * 1), -curve(-1 + event.pageY / window.innerHeight * 1));
	  }
	});
