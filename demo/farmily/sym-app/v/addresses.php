...
if(isset($_REQUEST['action'])){
			...
			if(isset($_REQUEST['id']) && $_REQUEST['action'] == "edit"){
				...
				<form class="form-horizontal" action="addresses.php?id=<?php echo $id; ?>&action=edit" method="post" id="addr-edit">
					...
					<label class="col-sm-5 control-label text-right" for="addr-name">Имя:</label><div class="col-sm-7">
					<input class="form-control" type="text" name="addr_name" value="<?php echo $addr['name'] ;?>" id="addr-name" ></div></div>
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-addr">Адрес:</label><div class="col-sm-7">
					<textarea  class="form-control" style="width:300px;height:100px;" name="addr_addr" id="addr-addr"><?php echo trim($addr['address']) ;?>
					</textarea></div></div>
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-c">Страна:</label><div class="col-sm-7">
					<input class="form-control" type="text" name="addr_c" value="<?php echo $addr['country'] ;?>" id="addr-c" ></div></div>	<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="product-shipping-region">Город:</label><div class="col-sm-7">
...
?></select></div></div>
					...
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-zip">Индекс:</label><div class="col-sm-7">
					<input class="form-control" type="text" name="addr_zip" value="<?php echo $addr['zip'] ;?>" id="addr-zip" ></div></div>
					
					<div class="form-group">
					<label class="col-sm-5 control-label text-right" for="addr-mob">Телефон:</label><div class="col-sm-7">
					<input class="form-control" type="text" name="addr_mob" value="<?php echo $addr['mobile'] ;?>" id="addr-mob" ></div></div>
					<div class="form-group">
					<div class="form-group"><div class="col-sm-7 col-sm-offset-5">
...
<?php echo "Индекс: " . $all_address[$i]['zip']; ?><br>
<?php echo "Mobile: " . $all_address[$i]['mobile']; ?><br>
<a class="btn btn-link" href="addresses.php?action=edit&id=<?php echo $all_address[$i]['id']; ?>">Изменить</a> <a class="btn btn-link" href="addresses.php?action=delete&id=<?php echo $all_address[$i]['id']; ?>">Удалить</a><br>
</div>
<?php
}
}
