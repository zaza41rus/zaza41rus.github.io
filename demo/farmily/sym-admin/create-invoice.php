...
<a href="orders.php" >Все заказы</a></li><li><a href="orders-new.php">Новые заказы</a></li><li><a href="orders-monthly.php" >Заказы по месяцам</a></li></ul><hr>
<div class="col-md-12">
<form action="create-invoice.php" method="post" class="form-inline">
<h4>Создать счет-фактуру</h4><span class="col-md-4 no-gutter"><input class="form-control"type="text" name="id" placeholder="Номер заказа" required>&nbsp;
</span><span class="col-md-4 no-gutter"><button class="btn btn-default">Создать счет-фактуру</button></span></form></div>
<?php 
if(isset($_REQUEST['id'])) {
...
<button class="btn btn-default" id="print-Button"><i class="glyphicon glyphicon-print"></i> Печать</button>
<br><br>
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="width:720px; padding:0px; padding-left:0px;margin:0px;text-align:left;vertical-align:top;">
         ...
         <table cellspacing="0" cellpadding="0" border="0" style="margin:0px; padding:0px;vertical-align:top;">
          <tbody><tr>
           ...
           <br><p style="vertical-align:top;margin-top:0px;margin-bottom:0px;text-align:right;letter-spacing:5px;font-size:28px;color:#808080;font-weight:bold;font-family:arial;">СЧЕТ-ФАКТРУРА</p>
<br>
        	</td></tr>
...
<br>
         ...
         <tr><td></td></tr>
           ...
           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineItem">Продукт </th>

           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineDescription">Опции </th>

           <th style="border-color:#ccc" class="invoiceDataHeadlineEmpty">&nbsp;</th>
           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineUnitPrice">Валюта&nbsp;Цена </th>

           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineQuantity">Кол-во </th>

           <th style="border-color:#ccc;color:white;" class="invoiceDataHeadlineAmount">Общая сумма </th>
...
?>
   ...
   <tr>
           ...
           <tr><td style="background-color:#eaedee; font-family:verdana; font-size:13px; color:#3c3c3c; font-weight:bold;border-bottom:1px solid #ccc;border-top:1px solid #ccc;padding-top:7px;padding-bottom:7px;padding-left:35px;padding-right:0px;margin-right:0px;" colspan="3">К&nbsp;оплате&nbsp;<span style="font-family:verdana;&nbsp;font-size:12px;&nbsp;color:#3c3c3c;&nbsp;font-weight:normal;"></span style="font-family:verdana;&nbsp;font-size:12px;&nbsp;color:#3c3c3c;&nbsp;font-weight:normal;"></td>
...
<?php  }else{
echo "<h2 align='center'>Неверный номер заказа</h2>";
}}?>
<?php
