...
<td><button class="btn btn-primary">Создать HTML код</button></td>
</tr>
</table>
</form><hr>
<div id="generated" style="display:none;">
<h3>Скопируйте код здесь</h3>
<h4>Купить код кнопки</h4>
<input id="btn-code" type="text" class="form-control input-lg"><br>
<p>Кнопку можно стилизовать добавлением стили <code>.cart-button .button</code> в CSS</p>
