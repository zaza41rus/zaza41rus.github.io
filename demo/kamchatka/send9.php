 <?php
$to = 'travel@kamchatka.love, zaza41rus@gmail.com, ilona-salo@mail.ru';
...
if ( isset( $_POST['sendMail'] ) ) {
  ...
  $email   = substr( $_POST['email'], 0, 64 );
   ...
   $range   = substr( $_POST['range'], 0, 64 );
    ...
    $checkbox4   = substr( $_POST['checkbox4'], 0, 64 );   
  ...
  $body .= "Дата по:\r\n".$data2."\r\n\r\n";
  $body .= "Кол-во человек:\r\n".$select."\r\n\r\n";
  $body .= "Планируемый бюджет на сутки всей группы:\r\n".$range."\r\n\r\n";

    
  $body .= "Необходим трансфер:\r\n".$checkbox1."\r\n\r\n";
  $body .= "Есть ограничениями по здоровью:\r\n".$checkbox2."\r\n\r\n";
  $body .= "Есть дети:\r\n".$checkbox3."\r\n\r\n";
  $body .= "Есть животные:\r\n".$checkbox4."\r\n\r\n";    
...
{
  $subject = 'Заявка на НОЧЛЕГ Kamchatka.love';
