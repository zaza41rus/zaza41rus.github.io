...
echo $option['name'] ." - " . $setting['currency_symbol'] . " " . $option['price'] . " - <a href='product-update-options.php?edit=" . $option['id'] . "&product_id=". $details['id'] ."'>Edit</a> | <a href='product-update-options.php?action=remove&remove=" . $option['id'] . "&product_id=". $details['id'] ."'>Remove</a><br />";
 } ?>
 <br>
