...
<input class="form-control" class="form-control"type="text" name="id" placeholder="Номер заказа" required></span><span class="col-md-4 no-gutter">
<button class="btn btn-primary">Показать Детали</button></span>
</form></div></div>
<hr>
<?php
if($order->msg){
...
<tr>
<td><?php echo $i;?></td>
<td><span class="symbiotic-img" data-size="small"><?php echo $pro['id']; ?></span> <?php echo $pro['name'] ; ?></td>
