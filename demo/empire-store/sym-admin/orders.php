...
?>
<ul class="nav nav-pills"><li><a href="orders-new.php" >New Orders</a></li><li><a href="orders-monthly.php" >Monthly Orders</a></li><li><a href="create-invoice.php" >Create Invoices</a></li></ul><hr>
<?php if(empty($orders)){
?>
