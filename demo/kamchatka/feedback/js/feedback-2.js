        ...
        success: function(answer) {
          ...
          if(isset(cfg.notify) && !/none/i.test(cfg.notify)) {
             ...
             if(/textbox/i.test(cfg.notify)) {
                 ...
                 $(vars.form).find('input[type=text]:visible, textarea:visible, select:visible').css({'border-bottom': '3px solid rgba(83, 161, 224)'}, 300);
                 if(isset(answer.errors)) {
                     $.each(answer.errors, function(k,val) {
                         var reg = /[a-z]/i;
                         if(reg.test(k)) {
                          ...
                          if(e.length == 1) {
                           $(e).css({'border-bottom': '3px solid #E46D70'}, 100);
                          }
                        }
                     });
                 } 
