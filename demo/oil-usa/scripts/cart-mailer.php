...
$adminMessageSubject = "Заказ OIL USA";
$adminMessageSubjectHtml = "Привет админ Заказ OIL USA, <h3>Вам поступил заказ с сайта</h3> <span style='color:#999999;'><strong>Дата заказа: </strong>" . date("l jS \of F Y h:i:s A") . " </span> <br><br> <strong>Информация по заказу: </strong><br>";

$customerMessageSubject = "Заказ OIL USA";
$customerMessageSubjectHtml = "Здравствуйте, <h3>Ваш заказ OIL USA: </h3> <span style='color:#999999;'><strong>Дата заказа: </strong>" . date("l jS \of F Y h:i:s A") . " </span> <br><br> <strong>Информация по вашему заказу: </strong><br>";
