...
Remember password? <a href="sign-in.php" class="btn btn-default">Sign in here</a>
...
<form class="form" action="sign-in.php" method="post" >
  ...
  <div class="form-group">
    <div>
      ...
      <button type="submit" class="btn btn-primary">Sign in</button> <!--<?php if(!empty($setting['fb_app_secret']) && !empty($setting['fb_app_secret'])){ ?><a target="_top" href='auth/facebook.php?ref=<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];?>' class="btn btn-default">Sign in with Facebook</a><?php } ?><!-->
    </div>
  </div>  
  <div class="form-group">
    <div>
