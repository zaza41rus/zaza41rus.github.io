...
<label class="col-sm-5 control-label text-right" for="edit-admin-email">Используемая Почта</label>
<div class="col-sm-7">
<input class="form-control" disabled type="text" name="edit_email" value="<?php echo $_SESSION['curr_user'];?>" id="edit-admin-email"></div>
</div>
<div class="form-group">
<label class="col-sm-5 control-label text-right" for="edit-pwd">Текущий Пароль</label><div class="col-sm-7">
<input class="form-control" type="password" name="edit_pwd" value="" id="edit-pwd">
</div></div>
<div class="form-group">
<label class="col-sm-5 control-label text-right" for="edit-new-pwd">Новый Пароль</label><div class="col-sm-7">
<input class="form-control" type="password" name="edit_new_pwd" value="" id="edit-new-pwd">
</div></div>
<div class="form-group">
<label class="col-sm-5 control-label text-right" for="edit-new-pwd2">Повторите Пароль</label><div class="col-sm-7">
