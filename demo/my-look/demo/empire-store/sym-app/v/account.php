...
<label class="col-sm-5 control-label text-right" for="edit-admin-email">Email ID</label>
<div class="col-sm-7">
<input class="form-control" disabled type="text" name="edit_email" value="<?php echo $_SESSION['curr_user'];?>" id="edit-admin-email"></div>
</div>
<div class="form-group">
<label class="col-sm-5 control-label text-right" for="edit-pwd">Current Password</label><div class="col-sm-7">
<input class="form-control" type="password" name="edit_pwd" value="" id="edit-pwd">
</div></div>
<div class="form-group">
<label class="col-sm-5 control-label text-right" for="edit-new-pwd">New Password</label><div class="col-sm-7">
<input class="form-control" type="password" name="edit_new_pwd" value="" id="edit-new-pwd">
</div></div>
<div class="form-group">
<label class="col-sm-5 control-label text-right" for="edit-new-pwd2">Repeat Password</label><div class="col-sm-7">
