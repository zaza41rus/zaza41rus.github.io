...
<div class="navbar navbar-inverse navbar-default navbar-fixed-top"><div class="container-fluid"><div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">Упраление корзиной</a>
    </div>
	<nav role="navigation" class="collapse navbar-collapse bs-navbar-collapse">
<ul class="nav navbar-nav">
<li><a href="orders.php">Заказы <?php if($num_new > 0){echo "<span class=\"badge\">".$num_new."</span>";}?></a></li>
<li><a href="product-add.php">Добавить продукт</a></li>
<li><a href="integration.php">Интеграция</a></li>
</ul>
...
<li><a href="<?php echo $setting['website_url'];  ?>" target="_blank">Перейти к сайту</a></li>
<li><a href="settings.php">Настройки сайта</a></li>
<li><a href="settings-admins.php?edit=1&user=<?php echo USER;?>">Настройки аккаунта</a></li>
