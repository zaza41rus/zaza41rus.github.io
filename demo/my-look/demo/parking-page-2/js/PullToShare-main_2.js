...
;(function(window) {
	...
	var bodyEl = document.body, 
		...
		networks = {
			...
			"facebook" : 'http://www.facebook.com/sharer.php?s=100&p[url]=http://buy-fish.ru/'+encodeURIComponent(window.location.href)+'&p[title]=' + document.title + '&p[summary]=Description',
